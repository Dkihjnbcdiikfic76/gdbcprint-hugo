...
params:
  moq: "1000"
  price: "0.45-1.80"
  material: "SBS Board / Art Paper / Gold Foil / Matte Lamination"
...
The Bincai Custom Reverse-Tuck Perfume Sleeve combines the efficiency of folding carton production with luxury cosmetics aesthetics. Crafted from 350gsm SBS board with matte lamination, a precision spot UV gloss pattern overlay, and gold foil hot-stamped branding — this reverse-tuck sleeve elevates perfume bottle presentation while remaining cost-effective for volume production. The custom die-cut window allows the fragrance bottle's design to shine through, while the reverse-tuck closure provides secure retail-ready presentation. Manufactured at our 18,000 sqm Foshan facility producing over 1.5 million folding cartons daily.

## Applications

| Industry | Application | Key Benefit |
|---|---|---|
| **Luxury Fragrance Brands** | Perfume bottle outer packaging, gift set sleeves | Spot UV + gold foil matches premium brand identity |
| **Indie Perfumers** | Niche fragrance packaging, artisan scent sleeves | Low MOQ 1,000 supports small-batch launches |
| **Duty-Free & Travel Retail** | Travel-size perfume set packaging | Compact reverse-tuck design maximizes shelf density |
| **Cosmetics Gift Sets** | Fragrance + body lotion combo sleeve packaging | Custom die-cut accommodates multi-product sets |
| **Subscription Boxes** | Monthly fragrance discovery box packaging | Flat-packed for efficient warehousing |
| **Department Store Retail** | Counter-top perfume display packaging | Reverse-tuck stands upright for counter presentation |

## Customization Options

| Option | Available Choices | Details |
|---|---|---|
| **Board Weight** | 300gsm, 350gsm, 400gsm SBS or FBB board | Choose thickness based on bottle weight |
| **Surface Finish** | Matte lamination, gloss lamination, soft-touch velvet, uncoated | Spot UV pattern overlay on any base finish |
| **Foil Colors** | Gold, rose gold, silver, holographic, copper, matte gold | Hot stamping or Heidelberg cold foil transfer |
| **Window Type** | Die-cut open window, PET clear window, shaped window | Custom die shape matches brand identity |
| **Closure Style** | Reverse tuck, straight tuck, auto-lock bottom, crash-lock | Reverse tuck preferred for perfume presentation |
| **Print Enhancement** | Spot UV, embossing, debossing, metallic Pantone ink | Up to 7 colors + UV coating in single pass |

## Production Specifications

| Specification | Detail |
|---|---|
| **Board** | 350gsm SBS (Solid Bleached Sulphate) board |
| **Lamination** | 1.2mil matte BOPP film lamination |
| **Spot UV** | High-build 3D spot UV varnish, 80-micron thickness |
| **Foil** | Gold hot foil stamping, Heidelberg ±0.1mm registration |
| **Printing** | KBA 1050 4-color offset + Heidelberg 7+1 UV |
| **Die Cutting** | Laser-cut die boards, ±0.3mm tolerance |
| **Quality Standards** | ISO 9001:2015, GMI packaging color certified |
| **Sustainability** | FSC Chain-of-Custody (SCS-COC-009852), recyclable |

## Quality Assurance

- **Color Consistency**: Delta E < 2.0 across production run via inline spectrophotometer
- **Foil Adhesion**: 3M 610 tape test — zero foil lift at all stamped areas
- **Structural Integrity**: ISTA 1A drop test with 200g perfume bottle — zero carton failure
