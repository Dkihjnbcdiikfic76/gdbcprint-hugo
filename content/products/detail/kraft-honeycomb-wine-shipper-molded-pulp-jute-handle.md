...
params:
  moq: "500-1000"
  price: "1.20-3.80"
  material: "FSC-certified kraft cardboard, honeycomb kraft core, biodegradable molded pulp, jute rope"
...
|---|---|---|
| Wine & Spirits | Organic & biodynamic wines | DTC wine club shipments, tasting room purchases |
| Craft Beverage | Natural wine & pét-nat | Limited release shipments, subscription boxes |
| Olive Oil | Premium estate-bottled oils | Gift sets, export sampling |
| Craft Beer | Barrel-aged & limited releases | Collector bottle shipping |
| Gourmet Food | Artisanal vinegar & syrups | Specialty food gift packs |
| Corporate Gifting | Sustainable corporate gifts | Eco-conscious client appreciation |

## Customization Options

- **Honeycomb Core:** Hexagonal cell sizes of 12mm, 15mm, or 21mm depending on required crush strength. Larger cells for lighter payloads, smaller cells for heavy champagne/magnum bottles
- **Bottle Configuration:** 1-bottle, 2-bottle, 3-bottle, and 6-bottle molded pulp inserts. Custom configurations for mixed bottle sizes (750ml + 375ml) or magnum (1.5L)
- **Board Outer:** Natural kraft (unbleached) or bleached white kraft. Optional clay-coated kraft for higher print fidelity
- **Printing:** Single or dual-color soy-based ink printing on kraft surface. Hot foil stamping for winery logo in gold, silver, or copper
- **Handle:** Natural jute rope (6mm diameter) with reinforced knot anchors. Optional cotton webbing handle for heavier loads
- **Closure:** Integrated tuck-top flaps with die-cut locking tabs. No tape or adhesive required for assembly
- **Branding:** Custom-printed wine information panel, tasting notes card slot, vintage and varietal labeling area
- **Inserts:** Biodegradable molded pulp with contoured bottle cradles. Optional divider wings for glass-to-glass separation in multi-bottle configurations
- **Add-ons:** Seed paper thank-you card, compostable cellulose window for bottle visibility, hemp twine additional securing

## Production Specifications

| Specification | Detail |
|---|---|
| Outer Board | FSC-certified kraft, 250-350 gsm |
| Honeycomb Core | Kraft paper, 12/15/21mm cell, 140 gsm |
| Core Thickness | 10-20mm (depending on protection level) |
| Molded Pulp | Post-industrial recycled paper, 2-3mm wall |
| Jute Handle | 6mm natural jute, breaking strength ≥50 kg |
| Printing Ink | Soy-based, heavy metal-free |
| Adhesive | Water-based PVA, formaldehyde-free |
| Flat Crush Resistance | ≥800 kPa |
| Edge Crush Test | ≥5.0 kN/m |
| Compostability | OK Compost HOME certified (EN 13432) |
| Weight (1-bottle) | 280-350g |

## Quality Assurance

| Gate | Check | Standard |
|---|---|---|
| Board Incoming | FSC CoC verification, grammage, moisture | FSC-STD-40-004 |
| Honeycomb Core | Cell geometry, bond strength, flat crush | GB/T 6546 |
| Molded Pulp | Wall thickness, density, dimensional tolerance ±1.5mm | Internal QC-SOP-10 |
| Jute Handle | Breaking strength ≥50 kg, knot slip resistance | Internal QC-SOP-11 |
| Soy Ink | Heavy metal screening, adhesion tape test | EN 71-3 |
| Drop Test | 0.8m drop on 6 faces with filled bottle | ISTA 1A |
| Compost Test | Disintegration ≥90% in 12 weeks | EN 13432 |
| Final Inspection | Print registration, handle attachment, insert fit | AQL 2.5 Level II |

## Sustainability & Compliance

- FSC Chain-of-Custody certified — all kraft paperboard traceable to responsibly managed forests
- OK Compost HOME certified (EN 13432) — fully biodegradable in home composting conditions within 12 weeks
- Soy-based printing inks — heavy metal-free, low VOC, safe for incidental food contact
- Water-based PVA adhesive — formaldehyde-free, REACH compliant
- Molded pulp from post-industrial recycled fiber — zero virgin wood fiber in inserts
