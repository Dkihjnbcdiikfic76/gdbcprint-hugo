...
- Nutraceutical brand launch kits and influencer seeding packages
- Luxury wellness and functional food subscription boxes
- Traditional Chinese medicine (TCM) and herbal extract presentation
- Sports nutrition and protein supplement premium packaging
- Clinical trial sample kits and medical professional detailing boxes
- Corporate wellness program gift packaging

## Customization Options
- Box style: two-piece rigid lid-and-base, book-style magnetic flip, or drawer-slide
- Interior: precision die-cut EVA foam tray (individual capsule/blister cavities), flocked PET vacuum-formed tray, or satin-covered foam
- Printing: full-color CMYK offset + Pantone spot colors + pharmaceutical-grade anti-counterfeit UV ink
- Surface finish: soft-touch matte lamination, anti-scratch gloss, linen-texture wrap, leatherette (PU)
- Foil stamping: gold, silver, rose gold, copper, or holographic foil on lid and spine
- Embellishments: embossing, debossing, spot UV gloss, raised UV doming
- Closure: hidden N35 neodymium magnets, magnetic flap, or ribbon-tie
- Security options: tamper-evident holographic seal, QR code anti-counterfeit label, serialized batch number printing
- Sustainability: FSC-certified greyboard, soy-based inks, water-based adhesive, plastic-free construction
- Size range: 60×60×40mm (trial size) to 300×200×80mm (family pack); fully custom dimensions

## Production Specifications
- Greyboard core: 2.0–3.0mm FSC-certified recycled greyboard; 1200–1600gsm density
- Exterior wrap: 157–250gsm art paper or 0.6mm PU leatherette, PVA cold-glued with mitered corners
- Printing: KBA 1050 4-color offset press for wrap sheets; Heidelberg 7+1 UV for foil registration and spot coating
- Foil stamping: Bobst SP 102 BMA — temperature 110–130°C, dwell 0.5–1.0s, multi-pass for up to 3 foil colors
- Die-cutting: Bobst flatbed die-cutter; box blank tolerance ±0.15mm
- Foam/cavity insert: CNC-milled EVA foam at 80–100 kg/m³ density, Shore A 45 hardness, cavity tolerance ±0.5mm
- Assembly: semi-automatic wrapping + manual foam insert placement + magnet alignment QC
- Daily output: up to 50,000 rigid boxes per shift on dedicated supplement packaging line
- Lead time: 12–18 days new tooling; 8–12 days repeat order; 5–7 days rush with surcharge

## Quality Details
- ISO 9001:2015 certified quality management system — full traceability from raw material to finished box
- FSC Chain-of-Custody certified — verify sustainable sourcing at every production stage
- AQL 2.5 Level II visual inspection per ISO 2859-1 sampling standard
