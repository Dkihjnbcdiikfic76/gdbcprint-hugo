...
params:
  moq: "1000"
  price: "0.80-3.50"
  material: "2.5mm greyboard wrapped with 157gsm art paper; satin ribbon; matte lamination + spot UV"
...
|---|---|---|
| Confectionery | Luxury Chocolates | Premium truffle and praline gift sets, seasonal collections |
| Gourmet Foods | Artisan Cookies & Pastries | High-end biscuit assortments, macaron boxes |
| Corporate Gifting | Holiday & Year-End Gifts | Branded gift boxes for client appreciation, employee recognition |
| Tea & Coffee | Premium Loose Leaf Tea | Specialty tea collections, rare coffee sampler sets |
| Wine & Spirits | Miniature & Accessory Sets | Mini liquor bottle sets, wine accessory gift kits |
| Beauty & Personal Care | Fragrance Gift Sets | Perfume and scented candle duo packaging |
| Luxury Stationery | Premium Notebook & Pen Sets | Executive stationery collections |
| Specialty Retail | Boutique Gift Packaging | Branded gift packaging for department stores and boutiques |

## Customization Options

- **Board & Construction:** Choose from 1.5mm to 3.0mm greyboard thickness; option for rigid chipboard or recycled greyboard. Lid depth and base depth independently customizable for visual proportion.
- **Printing & Color:** Full-color CMYK offset lithography on KBA 1050 4-color press; up to 4 spot colors (Pantone matching); soft-touch or gloss aqueous coating as base finish.
- **Surface Finishes:** Spot UV varnish for selective gloss-on-matte contrast; matte or gloss film lamination; soft-touch velvet lamination for tactile luxury.
- **Foil Stamping:** Hot foil stamping in gold, silver, rose gold, copper, or holographic foil — ±0.1mm registration accuracy on Bobst hot foil presses.
- **Embossing & Debossing:** Blind emboss, foil emboss, or multi-level sculptured emboss for dimensional branding.
- **Ribbon & Closure:** Satin, grosgrain, or velvet ribbon in custom colors and widths; magnetic closure option available as alternative to ribbon tie.
- **Interior:** Custom-fit die-cut foam, flocked vacuum-formed PET tray, satin or velvet lining, paperboard dividers for multi-compartment organization.
- **Sizing:** Fully custom dimensions — from compact 80×80×30mm single-piece boxes to 350×250×80mm multi-tier presentation cases.
...
| Board Thickness | 2.5mm greyboard (1.5–3.0mm available) |
| Wrapping Paper | 157gsm coated art paper (120–200gsm available) |
| Print Registration | ±0.15mm color-to-color |
| Foil Registration | ±0.1mm |
| Spot UV Registration | ±0.2mm |
...
Quality control for rigid gift boxes follows a comprehensive 7-stage gate process:

1. **Incoming Material Inspection:** Greyboard grammage and caliper verification; wrapping paper grammage, whiteness, and surface smoothness check; ribbon tensile strength and colorfastness test.
2. **In-Process Printing:** Spectrophotometer color check every 500 sheets; ΔE ≤ 2.0 target; Heidelberg Prinect inline registration monitoring.
3. **Die-Cutting & Creasing:** ±0.3mm dimensional tolerance; crease depth uniformity check to prevent cracking at fold lines.
4. **Lamination QC:** Peel adhesion test per ASTM D903; visual inspection for bubbles, delamination, or orange-peel texture.
5. **Assembly QC:** Lid-to-base fit clearance 0.5–1.0mm for smooth operation; ribbon attachment pull-tested to 5kg minimum; spot UV alignment verified under magnification.
6. **Finished Goods Audit:** AQL 2.5 (major defects), AQL 1.0 (minor defects) per ANSI/ASQ Z1.4; full functional test under D65 standard lighting.
7. **Pre-Shipment Inspection:** Random sample pull; ISTA 1A drop test from 760mm; compression strength verification; final visual under D65 lighting.
