...
params:
  moq: "1000-3000"
  price: "0.15-0.55"
  material: "SBS/CCNB 300-450gsm / Soft-Touch Matte Lamination / Spot Gloss UV / KBA 1050 4-color offset / Reverse Tuck End (RTE) / Auto-lock Bottom / Gold/Silver Hot Foil (optional) / Die-Cut Window (optional)"
  certification: "ISO 9001, FSC, SGS"
---

![Reverse Tuck Folding Carton — Soft-Touch Matte + Spot UV for Cosmetic & Skincare](/images/cat-fold-autolock.jpg)
...
## Applications
- Premium skincare cream and serum jar packaging
- Cosmetic tube, bottle, and pump dispenser boxes
- Face mask and sheet mask set packaging
- Luxury hand cream and body lotion gift cartons
- Essential oil and aromatherapy product boxes
- Beauty subscription box outer packaging
- Dermatologist and med-spa product packaging

## Customization Options
- Board grade: SBS (C1S/C2S) 300-450gsm or CCNB 350-450gsm for eco-conscious brands
- Surface finish: soft-touch matte, standard matte, glossy UV, linen texture, or pearlized
- Hot foil: gold, silver, rose gold, copper, holographic, or custom Pantone-matched foil
- Window options: die-cut window with clear PET/PVC film or PLA compostable film for product visibility
- Closure: reverse tuck end (standard), straight tuck end, or tuck-top snap-lock bottom
- Printing: CMYK 4-color offset (KBA 1050), up to 7-color + UV coating (Heidelberg 7+1)
- Branding: embossed/debossed logo, QR code printing, variable data for batch tracking

## Production Specifications
| Specification | Details |
|:---|---:|
| Press | KBA Rapida 105 4-color + Heidelberg Speedmaster 7+1 UV |
| Board | SBS (C1S/C2S) 300-450gsm, CCNB 350-450gsm |
| Max Sheet Size | 1050 × 720 mm |
| Drying | UV + IR + hot air, instant curing |
| Die-Cutting | Bobst Autoplaten, ±0.15 mm precision |
| Gluing | Automatic folder-gluer, 50,000 pcs/hr |
| QC Check | Barcode scan, spectrophotometer color check, manual AQL 2.5 sampling |
...
| **1.7M Daily Output** | Scale from 1,000 sample runs to 10M+ annual contracts |
...
A: MOQ is 1,000-3,000 units depending on size and complexity. Rush sample runs of 500 units are available with a surcharge.

**Q: Can you match a specific brand color or finish?**
A: Yes. We use spectrophotometer color management and can match any Pantone color. Soft-touch, matte, gloss, linen, and pearlized finishes are all available.

**Q: Is the soft-touch coating durable and fingerprint-resistant?**
A: Yes. Our soft-touch matte lamination is anti-scuff and fingerprint-resistant, tested for retail handling and shelf life.

**Q: Can I get a pre-production sample before bulk order?**
A: Absolutely. Digital mockups (2-3 days) and physical hard-proof samples via DHL/FedEx (7-10 days) are standard.
