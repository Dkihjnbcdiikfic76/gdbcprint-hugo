...
params:
  moq: "500"
  price: "0.60-3.00"
  material: "Molded Sugarcane Bagasse Fiber / Compostable PLA Film Window (30μm) / Soy-Based Ink Printing / Water-Based Adhesive"
...
- Luxury soap and bath bomb gift sets
- Essential oil and aromatherapy product boxes
- Eco-conscious cosmetics brand retail packaging
- Zero-waste beauty subscription boxes
- Vegan and cruelty-free brand product presentation

## Customization Options
- Molded fiber tray inserts: single cavity, multi-cavity (2–6 compartments)
- Color: natural unbleached (kraft brown), bleached white, or custom earth-tone dye
- PLA window: clear, frosted matte, tinted (amber, smoke, green)
- Window shape: rectangle, circle, oval, logo-shaped die-cut
- Printing: soy-based offset printing (CMYK + spot) on flat lid panels
- Embossed logo directly in molded fiber surface
- Hot foil stamping on flat areas: gold, silver, copper
- Magnetic closure with embedded N35 magnet in fiber flap
- Ribbon tie closure: organic cotton, hemp, or recycled PET satin
- Custom sizes: compact 60×60×30mm to large 250×180×80mm
- Interior lining: unbleached tissue paper, organic cotton, or bamboo silk

## Production Specifications

| Specification | Detail |
|---|---|
| Fiber Material | Sugarcane bagasse (post-industrial waste, renewable) |
| PLA Window | 30μm compostable film, EN 13432 certified |
| Molding Process | Thermoformed wet-press, 2–3mm wall thickness |
| Printing | KBA Rapida 105 4-color + Heidelberg CD 102 7+1 UV |
| Inks | Soy-based, VOC-free, REACH compliant, heavy-metal free |
| Adhesives | Water-based, solvent-free, compostable-grade |
| Drying | In-mold drying at 180–200°C for 60–90 seconds |
| Daily Output | 1.7M boxes across all product lines |
| Lead Time | 25–35 days (sample: 5–7 days) |
| Composting | 12 weeks to 90%+ biodegradation (industrial conditions) |

## Quality Details

| QC Gate | Standard | Test Method |
|---|---|---|
| Wall Thickness | 2.0–3.0mm ±0.2mm | Digital caliper |
| Fiber Density | 0.6–0.8 g/cm³ | Gravimetric measurement |
| PLA Window Clarity | Haze ≤ 10% | ISO 14782 spectrophotometer |
| Window Bond | ≥90% peel adhesion | Peel test per ASTM D903 |
| Print Registration | Δ ≤ 0.1mm | Optical comparator |
| Compostability | ≥90% biodegradation in 12 weeks | EN 13432 / ASTM D6400 |
| Water Resistance | No delamination after 30 min at 23°C/50% RH | Cobb test, TAPPI T-441 |
| Final Assembly | Full visual + functional inspection | AQL 1.0 |

## Sustainability & Environmental Responsibility

| Aspect | Bincai Initiative |
|---|---|
| Raw Material | 100% post-industrial sugarcane waste — no virgin wood fiber |
| PLA Window | Industrially compostable, derived from corn starch (non-GMO) |
| Inks | Soy-based, 100% VOC-free, heavy-metal free |
| Adhesives | Water-based, compostable-grade, solvent-free |
| Energy | 480 kWp rooftop solar array, closed-loop water system |
| Carbon Footprint | 60–70% lower than petroleum-based plastic boxes |
| Waste Recovery | 94% rate, fiber trim recycled back into pulp slurry |
| End-of-Life | 100% compostable — no separation required; industrial compost within 12 weeks |
