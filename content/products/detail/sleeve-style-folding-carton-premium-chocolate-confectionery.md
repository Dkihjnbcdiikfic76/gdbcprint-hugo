...
params:
  moq: "1000-3000"
  price: "0.35-2.50"
  material: "SBS Board / Art Paper / Kraft"
...
Custom sleeve-style folding carton for premium chocolate and confectionery packaging — manufactured by Guangdong Bincai Color Printing Co., Ltd., a full-chain packaging enterprise with 23 years of experience (founded 2003). The sleeve-style design wraps around a tray or inner box and slides open to reveal the product, delivering a luxury unboxing experience perfect for artisan chocolate bars, truffle collections, and premium confectionery sets. Produced on KBA 1050 4-color and Heidelberg 7+1 UV presses across our 18,000 sqm integrated facility. Daily output: 1.7 million color boxes.

## Applications

| Industry | Application | Key Feature |
|---|---|---|
| **Artisan Chocolate** | Single-origin bars, bean-to-bar collections | Sleeve showcases bar design; tray prevents breakage |
| **Luxury Truffles** | Multi-piece truffle sets, gift collections | Foil-stamped sleeve elevates perceived value for gifting |
| **Confectionery** | Caramel, nougat, toffee, praline assortments | Die-cut window option for product visibility |
| **Seasonal Gifts** | Christmas, Valentine's Day, Chinese New Year collections | Quick-turn seasonal foil designs; 12-day lead time |
| **Wedding Favors** | Personalized chocolate boxes, guest favors | Custom monogram foil + ribbon sleeve options |
| **Hotel Amenities** | Turndown chocolate packaging, VIP welcome boxes | Compact, elegant; brand-logo foil on sleeve |
| **Duty-Free / Travel** | Premium travel-exclusive chocolate sets | Secure sleeve closure prevents opening during transit |

## Customization Options

| Option | Available Choices | Details |
|---|---|---|
| **Structure** | Slipcase sleeve + tray, wrap-around sleeve, shoulder-neck sleeve, tuck-end sleeve | Structural design support from Bincai in-house team |
| **Board Grade** | 250gsm–400gsm SBS, 300gsm–450gsm FBB, 200gsm–350gsm coated kraft | Food-grade certified; FSC available for all grades |
| **Print Method** | CMYK offset (KBA 1050), Pantone spot (Heidelberg 7+1 UV), flexo for kraft | Up to 7 colors + coating in single pass |
| **Foil Stamping** | Gold, silver, rose gold, copper, holographic, matte gold, black foil | Hot foil on Heidelberg 7+1; ±0.15mm registration |
| **Coatings** | Soft-touch matte, gloss UV, spot UV, aqueous matte, sand-texture | Food-safe; no solvent residue; FDA/ EU 1935/2004 compliant |
| **Embossing** | Blind emboss, foil-emboss (registered), multi-level deboss | Custom magnesium/brass die; 3-day turnaround |
| **Window** | Die-cut window (PET film), die-cut window (open), double-window | PET thickness 0.2–0.5mm; food-grade clarity |
| **Size Range** | 80×80×15mm (single bar) to 300×200×50mm (multi-piece sets) | Custom dimensions at no tooling charge |
| **Closure** | Friction-fit sleeve, magnetic flap, ribbon belly band, tear-strip | Magnetic adds $0.15–0.30/unit |
| **Inserts** | Die-cut SBS tray, molded pulp tray, foam cavity insert | Keeps chocolates separated; prevents movement |
| **MOQ** | 1000 units (standard), 500 (trial with existing die) | Die cost: $60–120 one-time |

## Production Specifications

| Specification | Detail |
|---|---|
| **Primary Press** | KBA 1050 4-color offset (format 740×1050mm, 15,000+ sph) |
| **Specialty Press** | Heidelberg 7+1 UV (instant-cure coatings, foil registration) |
| **Die-Cutting** | Bobst flatbed die-cutter; ±0.2mm tolerance on sleeve/tray fit |
| **Gluing** | Fully automatic folder-gluer with inline barcode verification; 30,000+ units/hour |
| **Ink System** | Food-grade soy-based inks; low-migration UV inks for Heidelberg line |
| **Coating** | Water-based and UV coatings applied inline; no VOCs |
| **Board Moisture** | 6–8% at printing (climate-controlled storage); prevents warping |
| **Certifications** | ISO 9001:2015, FSC Chain-of-Custody, FDA 21 CFR, EU 1935/2004 |
...
| **Color Consistency** | ISO 12647-2 | Delta E ≤ 2.0 within run; ≤ 3.0 between runs |
| **Foil Adhesion** | ASTM D3359 | Class 4B minimum; no lifting after 10-tape pulls |
| **Sleeve-Tray Fit** | Internal FC-001 | Insertion force 2–8 N; removal force 1–5 N (smooth slide) |
| **Glue Bond** | TAPPI T-811 | ≥ 200 N/m peel strength; no delamination at 40°C/80% RH |
| **Food Contact Safety** | EU 1935/2004, FDA 21 CFR 176.170 | Migration testing per product; certificate provided |
| **Sensory (Taint/Odor)** | ISO 13302 (Robinson test) | No detectable taint transferred to chocolate at 40°C/24h |
...
Our premium chocolate sleeve cartons are produced across our **18,000 sqm dual-factory campus** (10,000 sqm established facility + 8,000 sqm smart factory commissioned 2025) in Foshan, Guangdong — with 23 years of confectionery packaging expertise since 2003:
