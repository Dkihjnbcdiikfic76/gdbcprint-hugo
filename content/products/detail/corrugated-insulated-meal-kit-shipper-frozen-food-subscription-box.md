...
params:
  moq: "500-1000"
  price: "0.80-2.50"
  material: "Double-Wall BC/EB Flute Corrugated / Thermal Insulation Liner / PET Gel Packs"
...
- Cold chain pharmaceutical and medical shipping
- Perishable food e-commerce (meat, seafood, dairy)
- Ice cream and frozen dessert direct-to-consumer
- Temperature-sensitive cosmetic and skincare shipping

## Customization Options
- **Dimensions**: Custom sizes for 2–6 meal portions or bulk family boxes
- **Corrugated Grade**: Single-wall (B/C/E flute), double-wall (BC/EB), or triple-wall for heavy loads
- **Printing**: Flexo CMYK, litho-laminated offset, or digital for short runs
- **Insulation**: Metallic bubble foil, recycled denim, moulded pulp, or EPS-free compostable liner
- **Closure**: Tear-strip open, self-seal adhesive, or tape-reinforced
- **Extras**: Branded gel packs, recipe card inserts, custom tissue paper, QR code for recycling
- **Sustainability**: FSC-certified kraft, water-based inks, 100% recyclable corrugated, compostable liner option

## Production Specifications
| Specification | Detail |
|---|---|
| Corrugator | BHS 2.5m Corrugator (BC, EB, B, E, C flutes) |
| Press | KBA 1050 4-Color Flexo / Offset Litho-Laminate |
| Material | Double-wall BC flute (6mm) or EB flute (4.5mm) kraft/test liner |
| Insulation | Metallic bubble foil or recycled denim liner, R-value 3.5+ |
| Closure | Perforated tear-strip + self-seal adhesive strip |
| MOQ | 500 units |
| Samples | Free pre-production sample, 5–7 working days |
| Lead Time | 12–18 working days after sample approval |
| Daily Output | 1.7 million boxes (corrugated + folding combined) |

## Quality Control Gates
1. **Paper Roll Inspection** — Burst strength (≥200 PSI), edge crush test (ECT ≥32 lbs/in), moisture content
2. **Corrugator Monitoring** — Flute height, bond strength, caliper inline on BHS digital control
3. **Print Registration** — Flexo registration within ±1mm, color density to Pantone standards
4. **Die-Cutting** — Score depth and slot accuracy, ±0.5mm tolerance
5. **Insulation Assembly** — Liner adhesion, gel pack fit, tear-strip perforation test
6. **Cold Chain Validation** — ISTA 7E thermal profiling, 24–48 hour temperature hold test
7. **Final QC** — AQL 2.5 Level II, drop test (1.2m, 6 faces), compression test
