...
params:
  moq: "500-1000"
  price: "2.00-7.00"
  material: "Greyboard 1200-1600gsm / Art Paper Wrap 157-250gsm / N35-N52 Magnets (dual) / Satin or Velvet Lining / Custom PU Foam Insert / Matte Lamination + Spot UV / Gold Hot Foil"
...
## Applications
- Luxury perfume and eau de parfum gift packaging
- Niche and artisanal fragrance brand presentation boxes
- Limited edition and collector's fragrance packaging
- Fragrance discovery set and travel-size collection boxes
- Premium cosmetics and skincare gift sets
- High-end corporate and VIP gift packaging
- Holiday and seasonal fragrance gift collections (Christmas, Mother's Day, Valentine's)

## Customization Options
- Exterior finish: matte lamination, soft-touch velvet, pearlized, linen texture, or glossy UV
- Hot foil: gold, silver, rose gold, copper, holographic, matte gold, or custom Pantone foil
- Spot UV: selective glossy raised pattern, brand logo highlight, or decorative border accents
- Interior lining: satin, velvet, suede, faux leather, or custom-printed fabric with brand pattern
- Foam insert: custom CNC-cut cavity for EDP/EDT bottle, atomizer, travel size, rollerball
- Closure: dual magnetic side flaps (current), single magnetic flap, drawer slide, or telescopic lid
- Insert configuration: single bottle, duo set (perfume + lotion), trio set, or multi-fragrance collection
- Additional features: ribbon pull, hidden drawer for samples, mirror insert, LED spotlight

## Production Specifications
- **Presses:** KBA Rapida 105 4-color offset + Heidelberg Speedmaster CD 102 7+1 UV
- **Die-cutting:** Bobst Autoplaten die-cutter — precision box structure and insert cavity cutting
- **Foil stamping:** Bobst hot foil stamping machine — gold, silver, holographic foils
- **Spot UV:** Selective UV coating machine with register accuracy ±0.2mm
- **Foam fabrication:** CNC contour cutting for custom bottle cavities
- **Gluing:** Automatic rigid box making line with magnetic pocket insertion
