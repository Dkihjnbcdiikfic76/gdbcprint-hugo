...
params:
  moq: "500-2000"
  price: "1.60-4.50"
  material: "FSC Certified Kraft Paperboard 350gsm / Natural Bamboo Pull Handle / Cotton Drawstring / Soy-Based Ink / Water-Based Adhesive"
...
FSC certified kraft paper drawer box designed for eco-conscious brands seeking fully sustainable luxury packaging. The slide-out drawer mechanism features a natural bamboo pull handle and an internal cotton ribbon stop to prevent drawer separation. Exterior printing uses soy-based inks on uncoated kraft paperboard for a tactile, organic aesthetic that communicates environmental commitment. The entire box — board, ink, adhesive, and handle — is 100% recyclable in standard paper waste streams and home-compostable (EN 13432 compliant materials). Manufactured by **Guangdong Bincai Color Printing Co., Ltd.** (founded 2003) in our FSC Chain-of-Custody certified Foshan facility with 1.7M daily output capacity.

## Applications
- Organic tea and herbal infusion gift packaging
- Natural cosmetic and skincare product boxing
- Artisan chocolate and confectionery drawer boxes
- Sustainable jewelry and accessory packaging
- Zero-waste shop product presentation
- Eco-friendly corporate gift and promotional kits
- Handmade soap and candle brand packaging
- Wedding favor boxes for eco-conscious celebrations

## Customization Options
| Option | Available Choices |
|---|---|
| **Size** | 120×90×40mm to 300×220×80mm (outer); custom dimensions available |
| **Board** | FSC kraft paperboard 300gsm, 350gsm, or 400gsm; post-consumer recycled option |
| **Color** | Natural kraft brown, bleached white kraft, or black kraft |
| **Handle** | Natural bamboo, FSC beechwood, cotton rope, hemp twine, or jute loop |
| **Printing** | Soy-based ink (1-4 colors); debossing (inkless) for zero-chemical option |
| **Ink Colors** | Black, white, metallic gold/copper (soy-based), or plant-derived pigment inks |
| **Drawer Stop** | Internal cotton ribbon, hemp cord, or kraft paper tab |
| **Stamping** | Blind debossing, foil-free heat embossing, or laser engraving |
| **Interior** | Unlined kraft, recycled tissue paper, or organic cotton lining |

## Production Specifications
- FSC certified kraft paperboard (Chain-of-Custody code available for client labeling)
- Soy-based offset ink printing — VOC-free and biodegradable
- Water-based adhesive for box assembly — solvent-free and non-toxic
- Precision die-cutting with ±0.3mm tolerance for smooth drawer slide action
- Automatic folder-gluer with drawer slide forming
- Bamboo handle routing and press-fit insertion (no adhesive required)
- Cotton ribbon threading and knotting with consistent 40mm pull length
- ISO 9001:2015 quality management with batch-level FSC traceability
- EN 13432 compliant material certification for industrial composting

## Quality Details
- Drawer slide force: 4–8N for smooth, controlled opening
- Handle pull strength: tested to 12kgf without handle separation
- Cotton ribbon stop: tested to 500+ drawer cycles without fraying
- Board tear resistance: ≥2.5 kPa·m²/g per ISO 1974
- Print registration: ±0.5mm on uncoated kraft surface
- Adhesive bond: ≥10N/cm seam strength at 23°C / 50% RH
- Moisture resistance: board integrity maintained at 60% RH / 23°C
- Color consistency: ΔE ≤ 3.0 on natural kraft substrate (inherent variation)
- 100% recyclable in standard paper/cardboard waste stream
...
- FSC Chain-of-Custody certified (License Code: FSC-C######)
