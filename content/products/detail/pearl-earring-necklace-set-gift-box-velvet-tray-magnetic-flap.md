...
params:
  moq: "500-1000"
  price: "2.20-5.80"
  material: "2.5mm Greyboard / Art Paper / Velvet Tray / Satin"
...
This dual-compartment pearl jewelry set box is designed for complete pearl jewelry collections — accommodating a pearl necklace in the main channel and matching pearl earrings in two dedicated stud slots. The custom vacuum-formed velvet tray holds each piece securely with die-cut recesses tailored to specific pearl sizes, preventing movement during shipping and providing a premium jewelry-counter presentation. The magnetic flap closure ensures easy one-hand opening for retail display while keeping contents protected during storage. Produced by Guangdong Bincai Color Printing — manufacturing premium packaging since 2003 — each box uses 2.5mm FSC-certified greyboard and 200gsm art paper wrap. Our 18,000 sqm facility with daily output of 1.7 million boxes guarantees consistent quality from sample to production. The box exterior can be fully customized with your brand's logo in hot foil stamping, embossing, or full-color printing, making it an ideal retail-ready packaging solution for pearl jewelry brands, jewelry store chains, and online luxury accessories retailers.

## Features

- **Dual-Compartment Tray**: Main necklace channel (custom length) + 2 earring stud slots (6-12mm)
- **Velvet Vacuum-Formed Tray**: Premium short-pile velvet over vacuum-formed PET tray for precise fit
- **Magnetic Flap**: 4 × N35 neodymium magnets for reliable closure and premium opening feel
- **Satin Pillow**: Necklace channel lined with satin pillow for scratch protection
- **Rigid Construction**: 2.5mm greyboard core for structural integrity and stacking strength
- **Art Paper Wrap**: 200gsm coated art paper with matte or gloss lamination
- **Hot Foil Stamping**: Gold, silver, rose gold, copper on lid exterior
- **Exterior Colors**: White, cream, black, navy, burgundy, custom Pantone
- **Print**: Heidelberg 7+1 UV for vibrant CMYK and crisp foil registration
- **Certifications**: ISO 9001:2015, FSC Chain-of-Custody

## Applications

- Pearl necklace and earring set retail packaging
- Jewelry brand collection presentation
- Bridal pearl jewelry gift packaging
- Department store fine jewelry counter display
- Online jewelry brand unboxing experience
- Jewelry trade show and exhibition presentation
- Corporate awards and recognition jewelry packaging

## Customization Options

- **Necklace Length**: Standard 45cm (18"); custom lengths 40-60cm
- **Pearl Size**: 6mm to 14mm pearl diameter; tray customized to match
- **Exterior Finish**: Matte lamination, gloss lamination, soft-touch, leatherette
- **Foil Colors**: Gold, silver, rose gold, copper, holographic, matte black
- **Embossing/Debossing**: Blind emboss or foil-stamped emboss on lid
- **Ribbon Pull**: Optional satin ribbon pull tab for easier flap opening
- **Custom Color**: Pantone-matched exterior and interior colors
- **Branding**: Full-color logo printing, hot foil logo stamping, or embossed logo
- **MOQ**: 500 standard; 2000 for custom tray molding

## Production Specifications

- **Greyboard**: 2.5mm (1200gsm equivalent) — FSC certified
- **Art Paper**: 200gsm C1S or C2S with aqueous or UV coating
- **Velvet Tray**: 0.8mm nylon flock on 0.5mm vacuum-formed PET sheet
- **Foil Stamping**: Bobst SP 102 BMA autoplaten, 200°C precision
- **Print Method**: KBA Rapida 1050 4-color offset + Heidelberg Speedmaster 7+1 UV
