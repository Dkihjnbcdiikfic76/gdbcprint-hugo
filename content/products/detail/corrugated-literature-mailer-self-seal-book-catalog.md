...
|-------------|---------|
| Books | Hardcovers, paperbacks, coffee table books, textbooks |
| Catalogs | Product catalogs, look books, annual reports |
| Magazines | Monthly subscriptions, special editions |
| Documents | Legal documents, certificates, portfolios |
| Flat Products | Vinyl records, artwork, framed prints |

## Customization Options

- **Size**: Custom length x width x depth from 200x150x20mm to 400x300x50mm
- **Flute Profile**: B-flute (standard), E-flute (thin/elegant), C-flute (heavy duty)
- **Printing**: Flexo 1-3 color, CMYK label, or full-color litho-laminate
- **Closure**: Self-seal adhesive, double-sided tape, or standard tuck
- **Add-ons**: Return label perforation, hang-hole for retail display, window cutout

## Production Quality

| QC Stage | Standard |
|----------|----------|
| Paperboard | Grammage ±3%, burst strength ≥200 kPa |
| Fluting | Crush resistance tested per batch, ECT ≥23 lb/in |
| Adhesive | Peel adhesion tested at 23°C and -10°C |
| Perforation | Tear force 2-6N — clean separation without premature tear |
| ISTA Testing | Random sample 3A drop test — 10 drops from 76cm |
...
| Experience | 22 years in corrugated packaging |
