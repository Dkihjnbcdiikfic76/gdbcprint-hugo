...
params:
  moq: "500-1000"
  price: "0.25-1.50"
  material: "Recycled Kraft Board 400gsm / PLA Compostable Window 50μm / Soy-Based Ink"
  certification: "ISO 9001, FSC, EN 13432 (PLA window)"
---
...
|---|---|
| **Board Material** | 100% recycled kraft board 400gsm, PCF (Process Chlorine Free), FSC Recycled certified |
| **Window Film** | PLA (polylactic acid) 50μm, EN 13432 certified compostable |
| **Construction** | Folding carton, machine-glued side seam, tuck-top closure |
| **Printing** | Offset 1-2 color with soy-based inks on KBA Rapida 105 4-color press |
| **Die Cutting** | Bobst Autoplaten SP 102-E, window and profile in single pass |
| **Quality Gates** | 6-point QC: board caliper, seam glue strength, window adhesion, print registration, tuck fit, final visual |
...
- **18,000 sqm Factory:** Integrated production eliminates carbon-intensive intermediate transport
- **Daily Output:** 1.7 million boxes — rapid turnaround from prototype to container load
- **Flexible MOQ:** 500-1,000 units; free pre-production sample in 3-5 business days

## Packaging & Shipping

- Flat-packed for maximum container efficiency (saves 70% freight volume vs erected)
- Master carton: 200-500 units per double-wall export carton (recycled kraft)
- Palletization: Standard 1200×1000mm export pallets
- FCL/LCL shipping; DDP door-to-door available to US, EU, UK, AU, and Middle East
