...
params:
  moq: "500-1000"
  price: "1.80-5.50"
  material: "2.0mm Greyboard / PU Leather-Look Paper / Velvet Flocking"
  certification: "ISO 9001, FSC"
---

![Bincai Premium Jewelry Box Set](/images/cat-rigid-jewelry.jpg)
...
|---|---|
| **Box Sizes (L×W×H)** | Large: 180×120×50mm / Medium: 120×80×40mm / Small: 60×60×35mm |
| **Material** | 2.0mm greyboard + PU leather-look paper wrap + velvet flocking interior |
| **Closure** | 2× N35 neodymium magnets per box (≥2.0 N/cm² pull force) |
| **Foil Stamping** | Gold, silver, rose gold, or custom Pantone — registration ±0.1mm |
| **Colors** | Black, navy, burgundy, cream, dark green, or custom Pantone |
| **MOQ** | 500–1000 units per size/color |
| **Lead Time** | 12–15 days (new tooling); 7–10 days (repeat orders) |
...
|---|---|---|
| Jewelry Retail | In-store display & gift packaging | Black PU + gold foil + black velvet |
| E-Commerce | Unboxing experience packaging | Custom brand color + embossed logo |
| Wedding / Bridal | Bridesmaid & groomsmen gift boxes | Cream/burgundy + rose gold foil |
| Corporate Gifts | Employee recognition, event favors | Navy + silver foil + custom insert |
| Luxury Boutique | High-end presentation sets | Custom Pantone + hot foil + satin pillow |

## Customization Options

| Option | Available Choices |
|---|---|
| **Box Shape** | Rectangle, heart, hexagonal, octagonal, book-style, drawer-slide |
| **Exterior Material** | PU leather-look (standard), genuine leather wrap, linen-textured paper, velvet-wrapped |
| **Interior Lining** | Velvet flocking, satin fabric, suede-look paper, silk-finish paper |
| **Insert Type** | Die-cut EVA foam, molded velvet tray, satin pillow, display card slot, ring bar |
| **Print Method** | Heidelberg 7+1 UV offset for foil registration precision |
| **Foil Colors** | Gold, silver, rose gold, copper, holographic, custom Pantone metallic |
| **Add-Ons** | Ribbon tie, magnetic gift card slot, LED light insert, NFC tag embedding |
...
| **UV Press** | Heidelberg Speedmaster CD 102 7+1 — specialty coatings instant cure |
| **Die-Cutting** | Bobst SP 102 flatbed — ±0.15mm registration |
| **Rigid Box Line** | Fully automatic corner-wrapping with velvet flocking station |
| **Magnet Insertion** | Precision N35 housing with flush-mount sealing |
| **Greyboard** | 1200–2000gsm FSC-certified recycled greyboard |
...
| Check | Standard |
|---|---|
| Material Inspection | GSM weight verification, color Delta E ≤ 2.5 |
| Flocking Density | ≥ 95% coverage, adhesion test pass |
| Magnet Pull Force | ≥ 2.0 N/cm² per magnet, 100% testing |
