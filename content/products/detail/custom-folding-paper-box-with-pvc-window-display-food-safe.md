...
- **Press**: KBA 1050 4-color offset — precision CMYK with Pantone spot color capability
- **Board Grades**: 250gsm/300gsm/350gsm/400gsm C1S or C2S art paper; SBS (solid bleached sulfate) for premium food
- **Inks**: Soy-based, low-migration, EN 71-3 & EU 1935/2004 compliant for food contact
- **Coatings**: Water-based aqueous (food-safe), UV-cured (non-contact side only)
- **Window Film**: 0.2-0.4mm clear PVC, anti-fog PET, or compostable PLA bio-film
- **Window Patching**: Hot-melt or cold-glue machine-applied, ±0.5mm placement precision
...
|---|---|
| **Structure** | Straight tuck, reverse tuck, auto-lock bottom, seal-end, gable-top |
| **Board** | 250gsm / 300gsm / 350gsm / 400gsm coated art paper or SBS |
| **Print Method** | CMYK offset, Pantone spot (up to 6 colors) |
| **Window Shape** | Rectangle, oval, custom contour die-cut |
| **Window Film** | Clear PVC, anti-fog PET, compostable PLA |
| **Finishes** | Matte/gloss aqueous, spot UV (non-contact areas), foil stamping |
| **Foil Colors** | Gold, silver, copper, holographic |
| **Closure** | Tuck-top, auto-lock, crash-lock, snap-lock |
| **Size Range** | 60×40×20mm to 350×250×100mm |
| **MOQ** | 500 units (standard), 3000+ (custom window die-cut) |

## Applications / Industry Use Cases

| Industry | Application | Key Feature |
|---|---|---|
| Bakery | Cookies, macarons, pastries | Grease-resistant board + clear window |
| Confectionery | Chocolates, truffles, candy | Gold foil + window for premium look |
| Tea & Coffee | Loose leaf tea, coffee bags | Aroma-seal structure + window display |
| Health Food | Granola bars, supplements | Food-safe soy inks + FSC board |
| Deli & Takeaway | Sandwiches, salads | Anti-fog PET window, grease-proof |
| Gifting | Holiday food sets, gift baskets | Full-bleed CMYK + ribbon window |

## Food Safety Compliance

| Standard | Requirement | Bincai Compliance |
|---|---|---|
| **EU 1935/2004** | Food contact materials | Low-migration inks, food-grade board |
| **EN 71-3** | Heavy metal migration | All inks certified below limits |
...
|---|---|
| **23 Years Food Packaging Experience** | Understanding of global food safety regulations — EU, FDA, CFDA compliance built into every production run |
