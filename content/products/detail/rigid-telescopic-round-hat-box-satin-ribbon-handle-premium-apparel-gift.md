...
params:
  moq: "200-500"
  price: "3.00-9.00"
  material: "1200-1600gsm Greyboard / 157gsm Art Paper Wrap / Specialty Paper / Satin Ribbon"
...
- Integrated satin ribbon carry handle in any color (double-knotted through reinforced eyelets)
- CMYK offset printing with Pantone spot color matching for exact brand colors
- Hot foil stamping in gold, silver, rose gold, copper, or holographic foil on lid and body
- Multi-level embossing and debossing for dimensional brand logos and patterns
- Matte, gloss, or soft-touch lamination with optional spot UV accent
- Custom interior: satin, velvet, or suede lining with tissue paper or foam insert
- Diameters from 150mm to 400mm; heights from 100mm to 350mm
- Optional magnetic closure on telescopic lid for secure transport
...
- 80+ skilled workers with specialized training in luxury rigid box construction
- ISO 9001:2015 and FSC Chain-of-Custody certified — quality and sustainability verified
- Free pre-production samples in 5-7 days with DHL/FedEx express shipping worldwide

## Sustainability & Compliance
- FSC-certified paper and greyboard from responsibly managed forests
- Soy-based inks available for eco-conscious brands
- Water-based adhesives with low VOC emissions
- Recyclable paper components — easy separation from metal eyelets and satin ribbon
- Compliance with EU REACH, US CPSIA, and California Proposition 65 standards

## Seven-Stage QC Gates
1. Incoming material inspection — greyboard thickness, paper GSM, ribbon tensile strength
2. Pre-press color verification — Pantone matching and registration check
3. In-line print quality monitoring — density, dot gain, color consistency
4. Post-forming structural inspection — cylinder roundness, lid fit tolerance
5. Handle and eyelet installation verification — pull test and alignment
6. Surface finish inspection — lamination coverage, foil adhesion, scratch resistance
7. Final audit per AQL 2.5 Level II — random sampling of finished units

## FAQ
**What is the minimum order quantity?** MOQ starts at 200 units. We can accommodate trial orders of 100 units at a small surcharge.

**Can you match my brand's exact Pantone color?** Yes. We use Pantone spot color matching on both KBA offset and Heidelberg UV presses for precise color reproduction.

**What sizes are available?** Standard diameters from 150mm to 400mm with heights from 100mm to 350mm. Custom dimensions are fully supported.

**How long does production take?** Standard production lead time is 15-20 working days after sample approval. Rush orders available at 10-12 days.

**Do you provide free samples?** Yes, we provide free pre-production samples with digital proof in 5-7 days. Customer pays express shipping.
